...
import { EventIcon } from './battleUi';
...
export default function BattleBroadcastToasts({ feed = [] }: BattleBroadcastToastsProps) {
  ...
  return (
    <div className="battle-broadcast-stack pointer-events-none absolute left-1/2 z-20 flex w-[min(680px,calc(100vw-2rem))] -translate-x-1/2 flex-col items-center gap-2">
