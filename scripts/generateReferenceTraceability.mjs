...
const routes = {
  ...
  items: ['REFERENCE_ITEMS / ITEM_DEFINITIONS', 'performSearch / applyBattleItemEffect', 'data/referenceTraceability.test.ts', 'BattleCharacterDrawer 物品效果'],
  zoneRules: ['BATTLE_CONFIG.zone', 'tickMatchRules / performIntervention', 'data/referenceTraceability.test.ts', 'LiveBattleHud 禁区状态'],
  characterAreas: ['CHARACTER_STORIES / BATTLE_CONFIG.areas', 'triggerCharacterStory / moveToBattleArea', 'data/referenceTraceability.test.ts', 'BattleCharacterDrawer 区域剧情'],
  ...
  interventions: ['INTERVENTION_OPERATIONS', 'performIntervention', 'data/referenceTraceability.test.ts', 'BattleRoyalePanel 导演台'],
  logs: ['REFERENCE_LOG_*', 'pushEvent / recordBattleDialogue', 'data/referenceTraceability.test.ts', 'LiveBattleHud 事件流'],
  ...
  scores: ['SCORE_RULES / COMBO_RULES / HIDDEN_MISSIONS', 'awardPopularity / completeMission', 'data/referenceTraceability.test.ts', 'LiveBattleHud 热度与任务'],
